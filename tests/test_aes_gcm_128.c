...
void test_aes_gcm_128_encr(const uint8_t *key, size_t key_len,
  ...
  ASSERT(cipher_intf_alloc(&aes_gcm_intf, &p_aes_gcm_128, key_len, tag_len,
...
int main() {
  ...
  test_aes_gcm_128_encr(aes_gcm_128_key_0, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_0, AES_AUTH_TAG_LEN_LONG);
  ...
  test_aes_gcm_128_encr(aes_gcm_128_key_1, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_1, AES_AUTH_TAG_LEN_LONG);
  /* Test case #2 */
  test_aes_gcm_128_encr(aes_gcm_128_key_2, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_2, AES_AUTH_TAG_LEN_LONG);
  ...
  test_aes_gcm_128_encr(aes_gcm_128_key_3, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_3, AES_AUTH_TAG_LEN_LONG);
  ...
  test_aes_gcm_128_encr(aes_gcm_128_key_4, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_4, AES_AUTH_TAG_LEN_LONG);
  ...
  test_aes_gcm_128_encr(aes_gcm_128_key_5, AES_GCM_128_KEY_LEN,
                        ...
                        aes_gcm_128_tag_5, AES_AUTH_TAG_LEN_LONG);
  ...
  test_aes_gcm_128_decr(aes_gcm_128_key_6, AES_GCM_128_KEY_LEN,
                        ...
                        sizeof(aes_gcm_128_pt_6), AES_AUTH_TAG_LEN_LONG, 1);
  ...
  test_aes_gcm_128_decr(
      ...
      sizeof(aes_gcm_128_aad_7), NULL, 0, AES_AUTH_TAG_LEN_LONG, 0);
  ...
  test_aes_gcm_128_decr(aes_gcm_128_key_8, AES_GCM_128_KEY_LEN,
                        ...
                        sizeof(aes_gcm_128_pt_8), AES_AUTH_TAG_LEN_LONG, 1);
  ...
  test_aes_gcm_128_decr(
      ...
      sizeof(aes_gcm_128_aad_9), NULL, 0, AES_AUTH_TAG_LEN_LONG, 0);

  /* Test case #10 */
  test_aes_gcm_128_decr(aes_gcm_128_key_10, AES_GCM_128_KEY_LEN,
                        aes_gcm_128_iv_10, AES_GCM_IV_LEN, aes_gcm_128_data_10,
                        sizeof(aes_gcm_128_data_10), aes_gcm_128_aad_10,
                        sizeof(aes_gcm_128_aad_10), aes_gcm_128_pt_10,
                        sizeof(aes_gcm_128_pt_10), AES_AUTH_TAG_LEN_LONG, 1);
  ...
  test_aes_gcm_128_decr(aes_gcm_128_key_11, AES_GCM_128_KEY_LEN,
                        ...
                        AES_AUTH_TAG_LEN_LONG, 0);

  /* Test case #12 */
  test_aes_gcm_128_decr(aes_gcm_128_key_12, AES_GCM_128_KEY_LEN,
                        aes_gcm_128_iv_12, AES_GCM_IV_LEN, aes_gcm_128_data_12,
                        sizeof(aes_gcm_128_data_12), aes_gcm_128_aad_12,
                        sizeof(aes_gcm_128_aad_12), aes_gcm_128_pt_12,
                        sizeof(aes_gcm_128_pt_12), AES_AUTH_TAG_LEN_LONG, 1);
  ...
  /* Test case #14 */
  test_aes_gcm_128_decr(aes_gcm_128_key_14, AES_GCM_128_KEY_LEN,
                        aes_gcm_128_iv_14, AES_GCM_IV_LEN, aes_gcm_128_data_14,
                        sizeof(aes_gcm_128_data_14), aes_gcm_128_aad_14,
                        sizeof(aes_gcm_128_aad_14), aes_gcm_128_pt_14,
                        sizeof(aes_gcm_128_pt_14), AES_AUTH_TAG_LEN_LONG, 1);
  ...
  /* Test case #16 */
  test_aes_gcm_128_decr(aes_gcm_128_key_16, AES_GCM_128_KEY_LEN,
                        aes_gcm_128_iv_16, AES_GCM_IV_LEN, aes_gcm_128_data_16,
                        sizeof(aes_gcm_128_data_16), aes_gcm_128_aad_16,
                        sizeof(aes_gcm_128_aad_16), aes_gcm_128_pt_16,
                        sizeof(aes_gcm_128_pt_16), AES_AUTH_TAG_LEN_LONG, 1);
