...
const uint8_t aes_gcm_128_ct_0[16] = {0x93, 0xfe, 0x7d, 0x9e, 0x9b, 0xfd,
                                      ...
                                      0xca, 0xfa, 0x73, 0x54};
const uint8_t aes_gcm_128_tag_0[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_tag_1[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_tag_2[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_ct_3[16] = {0x2c, 0xcd, 0xa4, 0xa5, 0x41, 0x5c,
                                      ...
                                      0x78, 0xc9, 0xb2, 0xfd};
const uint8_t aes_gcm_128_tag_3[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_tag_4[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_tag_5[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_6[16] = {0xf2, 0xa3, 0x07, 0x28, 0xed, 0x87,
                                       ...
                                       0x43, 0x5d, 0x3c, 0x16};
const uint8_t aes_gcm_128_data_6[16 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_6[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_7[16] = {0x26, 0x1a, 0x9e, 0xfd, 0x4f, 0x32,
                                       ...
                                       0xed, 0xcf, 0x8a, 0xdf};
const uint8_t aes_gcm_128_data_7[16 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_7[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_8[16] = {0x85, 0x60, 0xb1, 0x0c, 0x01, 0x1a,
                                       ...
                                       0x69, 0x2d, 0xaa, 0x17};
const uint8_t aes_gcm_128_data_8[13 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_8[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_9[16] = {0x22, 0x7f, 0x0d, 0xdd, 0xc7, 0x1a,
                                       ...
                                       0xb8, 0xdb, 0x0e, 0x15};
const uint8_t aes_gcm_128_data_9[13 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_9[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_10[16] = {0xcd, 0xf5, 0x49, 0x6a, 0x50, 0x21,
                                        ...
                                        0x80, 0x33, 0x7f, 0x9a};
const uint8_t aes_gcm_128_data_10[32 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_10[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_aad_11[16] = {0xb0, 0xeb, 0xb2, 0x6b, 0x9e, 0x27,
                                        ...
                                        0x7b, 0x7c, 0x7e, 0xb4};
const uint8_t aes_gcm_128_data_11[32 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_11[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_12[16 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_12[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_13[16 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_13[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_14[13 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_14[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_15[13 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_15[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_16[32 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_16[AES_AUTH_TAG_LEN_LONG] = {
...
const uint8_t aes_gcm_128_data_17[32 + AES_AUTH_TAG_LEN_LONG] = {
...
// const uint8_t aes_gcm_128_tag_17[AES_AUTH_TAG_LEN_LONG] = {
