...
typedef error_t (*kex_dealloc_func_t)(kex_ptr_t kex);
...
typedef error_t (*kex_derive_shared_key_func_t)(
    kex_ptr_t kex, kex_peer_share_ptr_t peer_data, const unsigned char *authkey,
    size_t authkey_len, unsigned char **shared_key, size_t *shared_key_len);
