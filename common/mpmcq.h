 ...
 * 
 * NOTE: By default, this will block until space is available in the queue.
 * To avoid blocking, use the MPMC_Q_FAIL_IMMEDIATELY flag.
 */
 ...
 * @return 0 on success, -1 on failure.
 * 
 * NOTE: By default, this will block until a chunk has been fetched from the queue.
 * To avoid blocking, use the MPMC_Q_FAIL_IMMEDIATELY flag.
 */
