...
int vcry_aead_encrypt(uint8_t *pt, size_t pt_len, const uint8_t *ad, size_t ad_len, uint8_t *ct);
int vcry_aead_decrypt(uint8_t *ct, size_t ct_len, const uint8_t *ad, size_t ad_len, uint8_t *pt);
